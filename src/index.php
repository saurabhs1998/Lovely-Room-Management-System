            ...
            <nav class="navbar navbar-expand-lg ">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../registration/SignUp.php">SignUp</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-7 col-sm-12">
                    ...
                    <p>Lpu consisted of large number of building so it become important to manage the allocation od room easily.
                    </p>
        ...
        <section class="section-2 container-fluid p-0">
            ...
            <div class="container-fluid text-center">
                <div class="numbers d-flex flex-md-row flex-wrap justify-content-center">
                    <div class="rect">
                        <h1>1000's</h1>
                        <p>Thousands of LPU sudents have got placed in top MNCs in USA, UK, Canada, Australia etc.</p>
                    </div>
                    <div class="rect">
                        <h1>600+</h1>
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item text-center">
                                ...
                                <div class="card mr-2 d-inline-block shadow-lg">
                                    <div class="card-img-top">
                                        <img src="../assest/sap.jpg" alt="Member"
                                            class="img-fluid border-radius p-4">
                                    </div>
                                    <div class="card-body">
                                        <h3 class="card-title">LPU Students to be trained on SAP Business Suite</h3>
